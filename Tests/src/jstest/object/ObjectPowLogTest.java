...
public class ObjectPowLogTest extends ObjectExpressionTest {
    public static final Dialect POW_LOG_DIALECT = ObjectExpressionTest.ARITHMETIC_DIALECT.copy()
            .rename("pow", "Power")
            .rename("log", "Log");
    ...
    public static void main(final String... args) {
        test(ObjectPowLogTest.class, ObjectPowLogTest::new, new PowLogTests(), args, POW_LOG_DIALECT);
    }
}